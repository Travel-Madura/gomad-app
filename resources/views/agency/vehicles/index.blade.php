...
<div>
    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-6 border-b border-[#E5E5E5] pb-3">
        ...
        <a href="{{ route('agency.vehicles.create') }}" class="btn-gomad-primary text-sm inline-flex items-center gap-2 self-start rounded-[12px]">
    ...
    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white border border-[#E5E5E5] rounded-[12px] overflow-hidden shadow-sm hover:border-[#C1121F] transition-colors">
            ...
            <div class="p-5">
                ...
                <div class="flex gap-2 border-t border-[#E5E5E5] pt-4">
                    <a href="{{ route('agency.vehicles.edit', $vehicle) }}" class="flex-1 text-center border border-[#E5E5E5] text-[#111111] py-2 rounded-[12px] text-sm font-medium hover:bg-[#F5F5F5] transition">Edit</a>
        ...
        <div class="col-span-full bg-white border border-[#E5E5E5] rounded-[12px] p-12 text-center text-gray-500 shadow-sm">
            ...
            <a href="{{ route('agency.vehicles.create') }}" class="text-[#C1121F] hover:underline mt-2 inline-block font-medium">+ Tambah Kendaraan</a>
        </div>
        @endforelse
    </div>
</div>
