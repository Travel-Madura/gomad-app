...
<div class="min-h-[80vh] flex items-center justify-center py-20 px-6 bg-[#F5F5F5]">
    <div class="w-full max-w-md">
        <div class="mb-8 text-center">
            <h1 class="text-3xl font-bold text-[#111111]">Masuk</h1>
        ...
        <div class="bg-white p-8 shadow-sm border border-[#E5E5E5] rounded-[12px]">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="email" name="email" value="{{ old('email') }}" 
                               class="w-full px-0 py-2 border-b-2 border-[#E5E5E5] focus:border-[#C1121F] outline-none transition bg-transparent text-[#111111]" 
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input :type="showPassword ? 'text' : 'password'" name="password" 
                                   class="w-full px-0 py-2 pr-8 border-b-2 border-[#E5E5E5] focus:border-[#C1121F] outline-none transition bg-transparent text-[#111111]" 
            ...
            <div class="mt-6 text-center text-sm">
                ...
                <a href="{{ route('register') }}" class="text-[#C1121F] font-semibold hover:underline">Daftar sekarang</a>
            </div>
        </div>
    </div>
</div>
