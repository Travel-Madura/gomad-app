...
<div class="min-h-[80vh] flex items-center justify-center py-20 px-6 bg-[#F5F5F5]">
    <div class="w-full max-w-md">
        <div class="mb-8 text-center">
            ...
            <h1 class="text-3xl font-bold text-[#111111] mb-2">Reset Password</h1>
        ...
        <div class="bg-white p-8 shadow-sm border border-[#E5E5E5] rounded-[12px]" x-data="{ showPassword: false, showConfirm: false }">
            <form action="{{ route('password.update') }}" method="POST">
                ...
                <div class="mb-4">
                    <label class="block text-[10px] font-mono uppercase tracking-wider text-gray-500 mb-1">Password Baru</label>
                    <div class="relative">
                        ...
                        <button type="button" @click="showPassword = !showPassword" class="absolute right-0 top-1/2 -translate-y-1/2 text-gray-400 hover:text-[#111111]">
                ...
                <div class="mb-6">
                    <label class="block text-[10px] font-mono uppercase tracking-wider text-gray-500 mb-1">Konfirmasi Password</label>
                    <div class="relative">
                        <input :type="showConfirm ? 'text' : 'password'" name="password_confirmation"
                               class="w-full px-0 py-2 pr-8 border-b-2 border-[#E5E5E5] focus:border-[#C1121F] outline-none bg-transparent text-[#111111] transition"
                               placeholder="Ulangi password" required>
                        <button type="button" @click="showConfirm = !showConfirm" class="absolute right-0 top-1/2 -translate-y-1/2 text-gray-400 hover:text-[#111111]">
