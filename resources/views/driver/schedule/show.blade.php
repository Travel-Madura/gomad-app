...
<div class="max-w-2xl mx-auto">
    ...
    <p class="text-gray-600 font-light mb-4">{{ $schedule->departure_date->format('d M Y') }} | {{ $schedule->departure_time }} | {{ $schedule->vehicle->plate_number }}</p>

    <h2 class="font-bold text-lg text-[#111111] mb-3 border-b border-[#E5E5E5] pb-2">Daftar Penumpang ({{ $schedule->bookings->sum('total_passengers') }})</h2>
