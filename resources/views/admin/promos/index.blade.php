...
<div>
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 gap-4 mb-6">
        ...
        <div class="bg-white border border-[#E5E5E5] rounded-[12px] p-4 text-center shadow-sm">
            <p class="text-[10px] font-mono uppercase tracking-wider text-gray-400">General</p>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-[#E5E5E5]">
                    ...
                    @empty
                    <tr><td colspan="6" class="px-4 py-8 text-center text-gray-500 font-light">Belum ada promo.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
